                            ...
                            Column(
                              children: [
                                ...
                                SizedBox(
                                  height: 540,
                                  child: FutureBuilder<List<FireModel>>(
                                    future: FireService().getFireModel("뮤지컬"),
                                    builder: (context, snapshot) {
                                      if (snapshot.hasData) {
                                        List<FireModel> datas = snapshot.data!;
                                        return ListView.builder(
                            ...
                            Column(
                              children: [
                                ...
                                SizedBox(
                                  height: 540,
                                  child: FutureBuilder<List<FireModel>>(
                                    future: FireService().getFireModel("연극"),
                                    builder: (context, snapshot) {
                                      if (snapshot.hasData) {
                                        List<FireModel> datas = snapshot.data!;
                                        return ListView.builder(
                            ...
                            Column(
                              children: [
                                ...
                                SizedBox(
                                  height: 540,
                                  child: FutureBuilder<List<FireModel>>(
                                    future: FireService().getFireModel("전시"),
                                    builder: (context, snapshot) {
                                      if (snapshot.hasData) {
                                        List<FireModel> datas = snapshot.data!;
                                        return ListView.builder(
                            ...
                            Column(
                              children: [
                                ...
                                SizedBox(
                                  height: 540,
                                  child: FutureBuilder<List<FireModel>>(
                                    future: FireService().getFireModel("콘서트"),
                                    builder: (context, snapshot) {
                                      if (snapshot.hasData) {
                                        List<FireModel> datas = snapshot.data!;
                                        return ListView.builder(
                            ...
                            Column(
                              children: [
                                ...
                                SizedBox(
                                  height: 540,
                                  child: FutureBuilder<List<FireModel>>(
                                    future: FireService().getFireModel("클래식"),
                                    builder: (context, snapshot) {
                                      if (snapshot.hasData) {
                                        List<FireModel> datas = snapshot.data!;
                                        return ListView.builder(
                            ...
                            Column(
                              children: [
                                ...
                                SizedBox(
                                  height: 540,
                                  child: FutureBuilder<List<FireModel>>(
                                    future: FireService().getFireModel("페스티벌"),
                                    builder: (context, snapshot) {
                                      if (snapshot.hasData) {
                                        List<FireModel> datas = snapshot.data!;
                                        return ListView.builder(
                            ...
                            Column(
                              children: [
                                ...
                                SizedBox(
                                  height: 540,
                                  child: FutureBuilder<List<FireModel>>(
                                    future: FireService().getFireModel("문화예술기타"),
                                    builder: (context, snapshot) {
                                      if (snapshot.hasData) {
                                        List<FireModel> datas = snapshot.data!;
                                        return ListView.builder(
                            ...
                            Column(
                              children: [
                                ...
                                SizedBox(
                                  height: 540,
                                  child: FutureBuilder<List<FireModel>>(
                                    future: FireService().getFireModel("수영"),
                                    builder: (context, snapshot) {
                                      if (snapshot.hasData) {
                                        List<FireModel> datas = snapshot.data!;
                                        return ListView.builder(
                            ...
                            Column(
                              children: [
                                ...
                                SizedBox(
                                  height: 540,
                                  child: FutureBuilder<List<FireModel>>(
                                    future: FireService().getFireModel("야구"),
                                    builder: (context, snapshot) {
                                      if (snapshot.hasData) {
                                        List<FireModel> datas = snapshot.data!;
                                        return ListView.builder(
                            ...
                            Column(
                              children: [
                                ...
                                SizedBox(
                                  height: 540,
                                  child: FutureBuilder<List<FireModel>>(
                                    future: FireService().getFireModel("축구"),
                                    builder: (context, snapshot) {
                                      if (snapshot.hasData) {
                                        List<FireModel> datas = snapshot.data!;
                                        return ListView.builder(
                            ...
                            Column(
                              children: [
                                ...
                                SizedBox(
                                  height: 540,
                                  child: FutureBuilder<List<FireModel>>(
                                    future: FireService().getFireModel("농구"),
                                    builder: (context, snapshot) {
                                      if (snapshot.hasData) {
                                        List<FireModel> datas = snapshot.data!;
                                        return ListView.builder(
                            ...
                            Column(
                              children: [
                                ...
                                SizedBox(
                                  height: 540,
                                  child: FutureBuilder<List<FireModel>>(
                                    future: FireService().getFireModel("미식축구"),
                                    builder: (context, snapshot) {
                                      if (snapshot.hasData) {
                                        List<FireModel> datas = snapshot.data!;
                                        return ListView.builder(
                            ...
                            Column(
                              children: [
                                ...
                                SizedBox(
                                  height: 540,
                                  child: FutureBuilder<List<FireModel>>(
                                    future: FireService().getFireModel("양궁"),
                                    builder: (context, snapshot) {
                                      if (snapshot.hasData) {
                                        List<FireModel> datas = snapshot.data!;
                                        return ListView.builder(
                            ...
                            Column(
                              children: [
                                ...
                                SizedBox(
                                  height: 540,
                                  child: FutureBuilder<List<FireModel>>(
                                    future: FireService().getFireModel("복싱"),
                                    builder: (context, snapshot) {
                                      if (snapshot.hasData) {
                                        List<FireModel> datas = snapshot.data!;
                                        return ListView.builder(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(
                      height: 540,
                      child: FutureBuilder<List<FireModel>>(
                        future: FireService().getFireModel("기타"),
                        builder: (context, snapshot) {
                          if (snapshot.hasData) {
                            List<FireModel> datas = snapshot.data!;
                            return ListView.builder(
