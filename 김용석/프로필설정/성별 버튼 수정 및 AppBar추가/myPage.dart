                ...
                child: SizedBox(
                  ...
                  child: Stack(
                    children: <Widget>[
                      ...
                      Pinned.fromPins(
                        ...
                        child: Container(
                          child: ToggleButtons(
                            ...
                            onPressed: (int index) {
                              setState(() {
                                for (int buttonIndex = 0; buttonIndex < _selectedGender.length; buttonIndex++) {
                      ...
                      //* 자기소개 TextField */
                      Pinned.fromPins(Pin(size: 300.0, start: 36.0),
                      ...
                      ///** 프로필 이름 입력 TextField */
                      Pinned.fromPins(Pin(size: 130.0, start: 36.0),
