    ...
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          actions: [
            ...
            SearchBarAnimation(
                ...
                searchBoxColour: Color(0xfff4f4f4),
      ...
      bottomNavigationBar: Container(
        ...
        decoration: BoxDecoration(
            border: Border(top: BorderSide(color: const Color(0xff767676)))),
        child: BottomAppBar(
          child: new Row(
                          ...
                          Row(
                            children: [
                              ...
                              Container(
                                child: TextButton(
                                  onPressed: () {
                                    if (_cultureCategoriesController
                                        .hasClients) {
                                      _cultureCategoriesController
                                          .animateToPage(
                                        0,
                                        duration:
                          ...
                          Row(
                            children: [
                              ...
                              Container(
                                child: TextButton(
                                  onPressed: () {
                                    if (_sportsCategoriesController
                                        .hasClients) {
