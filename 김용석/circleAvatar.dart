                ...
                child: Stack(
                  children: <Widget>[
                    Pinned.fromPins(
                      ...
                      Pin(size: 96.0, start: 131.0),
                      child: Stack(
                        children: <Widget>[
                          Stack(
                            children: <Widget>[
                              //**Avatar Circle *
                              Pinned.fromPins(Pin(start: 11.2, end: 10.0),
                                  Pin(size: 80.1, end: 0.0),
                                  child:  CircleAvatar(
                    ...
                    Pinned.fromPins(
                      ...
                      child: Stack(
                        children: <Widget>[
                          ...
                          Align(
                            alignment: Alignment(0.597, -0.614),
                            child: SizedBox(
                              width: 2.0,
                              height: 2.0,
                              child: SvgPicture.string(
                        ...
                        children: <Widget>[
                          Stack(
                            children: <Widget>[
                              ...
                              Pinned.fromPins(
                                Pin(size: 6.0, middle: 0.6046),
                                Pin(start: 2.2, end: 2.5),
                                child: SvgPicture.string(
                                  _svg_zk91h,
                                  allowDrawingOutsideViewBox: true,
                                  fit: BoxFit.fill,
                    ...
                    Pinned.fromPins(
                      ...
                      child: Container(
                        child: OutlinedButton(
                          ...
                          child:
                              Text('확인', style: TextStyle(color: Colors.black)),
                          onPressed: () {},
                        ),
                      ),
                    ),
